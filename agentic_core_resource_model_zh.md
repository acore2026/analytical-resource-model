...
下表固定用户规模和事件频率，仅改变全部请求中携带意图的比例。可见结果使用分段式非线性负载模型。
...
| 1% | 1.0% | 1,043 | 104 | 13,768 | 182.4 | 71.2% | 57.140 Gbps | 45.8% | 8 | 6.879 Gbps | 24.9 ms | 148.1 ms | 退化 |
| 5% | 5.0% | 5,215 | 522 | 79,164 | 190.5 | 74.4% | 72.092 Gbps | 65.8% | 32 | 7.280 Gbps | 26.1 ms | 178.0 ms | 退化 |
