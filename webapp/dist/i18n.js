export const I18N = {
    en: {
        ...
        intentSweepDescription: "X-axis: intent-bearing share across all request types, sampled every 1 percentage point. Results use fixed nonlinear load bands. Y-axis: CPU, network, and NPU utilization.",
    ...
    zh: {
        ...
        intentSweep: "意图比例扫描",
        intentSweepDescription: "横轴表示全部请求类型中携带意图的比例，每 1 个百分点采样一次。结果采用固定的非线性负载分档。纵轴表示 CPU、网络和 NPU 利用率。",
        xAxisLabel: "意图比例（%）",
