export const I18N = {
    en: {
        ...
        nonlinearKnee: "Nonlinear knee",
        nonlinearAlpha: "Nonlinear overhead",
        nonlinearPower: "Nonlinear curve power",
        ...
        intentSweepDescription: "X-axis: intent-bearing share across all request types. Results use a nonlinear contention multiplier after 60% load. Left Y-axis: CPU and network utilization. Right Y-axis: required Qwen3 NPUs.",
        ...
        userCountSweepDescription: "Intent ratio is fixed at 20%. The nonlinear model adds contention overhead after 60% load; Qwen3 line shows required NPU count.",
        ...
        nonlinearKneeTip: "Utilization point where contention overhead begins. The default 60% keeps low-load behavior close to linear.",
        nonlinearAlphaTip: "Maximum extra resource overhead at full load. The default 60% means cost can reach 1.6x near saturation.",
        nonlinearPowerTip: "Shape of the nonlinear curve after the knee. The default 2.0 makes overhead grow smoothly.",
    ...
    zh: {
        ...
        hbmPerNpu: "每 NPU HBM",
        nonlinearKnee: "非线性拐点",
        nonlinearAlpha: "非线性额外开销",
        nonlinearPower: "非线性曲线指数",
        ...
        intentSweep: "意图比例扫描",
        intentSweepDescription: "横轴表示全部请求类型中携带意图的比例。结果采用 60% 负载后的非线性竞争开销。左纵轴表示 CPU 和网络利用率，右纵轴表示所需 Qwen3 NPU 数量。",
        xAxisLabel: "意图比例（%）",
        yAxisLabel: "CPU/网络利用率（%）· Qwen3 NPU 数",
        intentSweepAria: "折线图，展示不同意图比例下的 CPU 利用率、网络利用率和所需 Qwen3 NPU 数量。",
        userCountSweep: "用户规模敏感性",
        userCountSweepDescription: "意图比例固定为 20%。非线性模型在 60% 负载后增加竞争开销；Qwen3 折线表示所需 NPU 数量。",
        ...
        nonlinearKneeTip: "开始引入竞争开销的利用率点。默认 60% 表示低负载下接近线性。",
        nonlinearAlphaTip: "满负载附近的最大额外资源开销。默认 60% 表示成本最高约为 1.6 倍。",
        nonlinearPowerTip: "拐点后的非线性曲线形状。默认 2.0 表示开销平滑上升。",
