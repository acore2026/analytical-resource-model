export const I18N = {
    en: {
        ...
        qwen3SourceNote: "Source: GPUStack reports 15,591.71 total tokens/s for Qwen3-30B-A3B Medium Prompt serving on Ascend 910B, with Mean TPOT 194.54 ms; vLLM-Ascend recommends TP >= 4 for 32 GB NPU cards.",
        ...
        qwen3InputTokensTip: "Input tokens per complex intent request. The GPUStack Medium Prompt benchmark default is 2,000.",
        qwen3OutputTokensTip: "Output tokens per complex intent request. The GPUStack Medium Prompt benchmark default is 100.",
        qwen3TokenCapacityTip: "Reference Qwen3 serving capacity. GPUStack reports 15,591.71 total tokens/s for the optimized Medium Prompt Ascend 910B benchmark.",
    ...
    zh: {
        ...
        qwen3SourceNote: "来源：GPUStack 报告 Qwen3-30B-A3B 在 Ascend 910B Medium Prompt 服务下达到 15,591.71 total tokens/s，Mean TPOT 为 194.54 ms；vLLM-Ascend 建议 32 GB NPU 卡使用 TP >= 4。",
        ...
        qwen3InputTokensTip: "每个复杂意图请求的输入 token 数。GPUStack Medium Prompt 基准默认值为 2,000。",
        qwen3OutputTokensTip: "每个复杂意图请求的输出 token 数。GPUStack Medium Prompt 基准默认值为 100。",
        qwen3TokenCapacityTip: "参考 Qwen3 服务能力。GPUStack 在优化后的 Ascend 910B Medium Prompt 基准中报告 15,591.71 total tokens/s。",
