...
function eventLoads(userCountOverride = num("userCount")): EventLoad[] {
...
function evaluate(intentRatioPercent = num("intentRatio"), userCountOverride = num("userCount")): Result {
