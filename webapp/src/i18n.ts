...
export const I18N: Record<Lang, Record<string, string>> = {
  en: {
    ...
    intentSweepDescription: "X-axis: intent-bearing share across all request types. Results use fixed nonlinear load bands. Left Y-axis: CPU and network utilization. Right Y-axis: required Qwen3 NPUs.",
  ...
  zh: {
    ...
    intentSweep: "意图比例扫描",
    intentSweepDescription: "横轴表示全部请求类型中携带意图的比例。结果采用固定的非线性负载分档。左纵轴表示 CPU 和网络利用率，右纵轴表示所需 Qwen3 NPU 数量。",
    xAxisLabel: "意图比例（%）",
