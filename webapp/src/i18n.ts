...
export const I18N: Record<Lang, Record<string, string>> = {
  en: {
    ...
    qwen3LatencyTip: "Per-request Qwen3 service time for complex intents. Queueing delay is excluded from the primary model.",
    ...
    latencyNoQueueNote: "Latency excludes queueing; overload is shown as capacity risk.",
    stable: "stable",
    degraded: "degraded",
    high_risk: "high risk",
    unstable: "unstable",
  ...
  zh: {
    ...
    qwen3LatencyTip: "复杂意图请求的 Qwen3 服务时间。主模型不包含排队时延。",
    ...
    latencyNoQueueNote: "时延不包含排队；过载通过容量风险状态表示。",
    stable: "稳定",
    degraded: "退化",
    high_risk: "高风险",
    unstable: "不稳定",
